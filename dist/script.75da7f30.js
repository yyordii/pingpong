...
var Ball = /*#__PURE__*/function (_GameObject) {
  function Ball(x, y, radius, color) {
    ...
    _this = _callSuper(this, Ball, [x, y, radius * 2, radius * 2, speed, color]);
    _this.radius = radius;
    _this.speedX = speedX;
    _this.speedY = speedY;
...
var Game = /*#__PURE__*/function () {
  function Game() {
    ...
    var blockHeight = 130;
    var blockSpeed = 5;
    var blockColor1 = "blue";
    var blockColor2 = "red";
    var blockOffset = 100;
    this.mode = 'ai';
    this.gamePaused = true;
    this.timerInterval = null;
    this.obj1 = new GameObject(blockOffset, window.innerHeight / 2 - blockHeight / 2, blockWidth, blockHeight, blockSpeed, blockColor1);
    this.obj2 = new GameObject(window.innerWidth - blockWidth - blockOffset, window.innerHeight / 2 - blockHeight / 2, blockWidth, blockHeight, blockSpeed, blockColor2);
  ...
  return _createClass(Game, [{
    ...
    value: function update() {
      ...
      if (scorer && this.timer > 0) {
        // Add condition to check if timer is greater than 0
        this.gamePaused = true;
      ...
      window.addEventListener("keydown", function (event) {
        ...
        if (event.key === " ") {
          ...
          if (_this2.gamePaused) {
            _this2.pauseTimer(); // Pause the timer when the game is paused
          } else {
            _this2.startTimer(); // Start the timer when the game starts
          }
        }
    ...
    value: function showFireworks() {
      ...
      var fireworks = new _fireworksJs.Fireworks(container, {
        ...
        // minimum height for random explode
        explosionMaxHeight: 200,
        // maximum height for random explode
        ...
        this.timerInterval = setInterval(function () {
          if (_this3.timer > 0) {
            ...
            if (_this3.timer === 0) {
              ...
              _this3.showFireworks(); // Show fireworks when the game ends
            }
          }
        }, 1000);
      }
